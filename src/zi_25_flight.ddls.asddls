...
define root view entity ZI_25_Flight as select from sflight
composition [0..*] of ZI_25_Booking as _Bookings
association [1..1] to ZI_25CarrierText as _CarrierText on $projection.CarrierID = _CarrierText.Carrid
